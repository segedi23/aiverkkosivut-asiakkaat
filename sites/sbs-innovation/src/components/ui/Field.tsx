...
function fieldClassName(className?: string) {
  return cn(
    'min-h-12 w-full rounded-2xl border border-[var(--line)] bg-white px-4 py-3 text-[0.96rem] text-[var(--text-strong)] shadow-[0_14px_32px_rgba(10,10,10,0.05)] outline-none transition placeholder:text-[var(--text-soft)] focus:border-[var(--brand-blue)] focus:ring-2 focus:ring-[rgba(224,96,64,0.18)]',
    className,
  )
}
